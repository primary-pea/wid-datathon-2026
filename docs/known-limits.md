...
- **The registry snapshot is dated.** GIFNA exports of 3–5 September 2026; the topic clusters come from 47 token patterns ([`scaffold/inputs/gifna_cluster_rules.csv`](../scaffold/inputs/gifna_cluster_rules.csv)), and unmatched tokens are reported rather than guessed.
